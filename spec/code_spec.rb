...
RSpec.describe Code do
  ...
  examples =
    [
      ...
      %w[!!true true],
      %w[!false true],
      ["children = [1] !children.nothing?", "true"],
      ["children = [1] !(children.nothing?)", "true"],
      ["children = nothing !children.nothing?", "false"],
      ["children = [] !children.nothing?", "true"],
      ["!{ children: [1] }.children.nothing?", "true"],
      ["![nothing][0].nothing?", "false"],
      ["!nothing&.nothing?", "true"],
      ["![1].nothing?()", "true"],
      ["!![1].nothing?", "false"],
      ["![1].nothing? && false", "false"],
      ["![1].nothing? == true", "true"],
      ["children = [1]\nif !children.nothing? :available else :unavailable end", ":available"],
      ["children = nothing\nif !children.nothing? :available else :unavailable end", ":unavailable"],
      ["-1.abs", "1"],
      ["+1.to_string", "'1'"],
      ["-2 ** 2", "-4"],
      ["-2 * 3", "-6"],
