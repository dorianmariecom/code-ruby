...
RSpec.describe Code::Object::Dictionary do
  ...
  [
    ...
    ["{ a: 1 }.to_dictionary", "{ a: 1 }"],
    ["{ a: 1 }.entries", "[[:a, 1]]"],
    ["Dictionary.entries({ a: 1 })", "[[:a, 1]]"],
    ["Dictionary.from_entries([[:a, 1], [:b, 2]])", "{ a: 1, b: 2 }"],
    ["Dictionary.assign({ a: 1 }, { b: 2 })", "{ a: 1, b: 2 }"],
    ["Dictionary.has_own?({ a: 1 }, :a)", "true"],
    ["{ a: 1 }.has_own?(:b)", "false"],
    ["{ a: 1 }.associate(:a)", "[:a, 1]"],
